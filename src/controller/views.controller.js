...
export default class ViewController {
    get = async (req, res, next) => {
        ...
        try {
            ...
            (products.hasNextPage == true) ? nextLink = `http://coderhouse-backend-production-7e93.up.railway.app/?limit=${limit}&page=${page + 1}&query=${query}` : nextLink = null;
            (products.hasPrevPage == true) ? prevLink = `http://coderhouse-backend-production-7e93.up.railway.app/?limit=${limit}&page=${page - 1}&query=${query}` : prevLink = null;
