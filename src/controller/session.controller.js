        ...
        try {
            ...
            try {
                transport.sendMail({
                    ...
                    html: `
                <div style="background-color: black; color: #F9C521; display: flex; flex-direction: column; justify-content: center;  align-items: center;">
                <h1>Para reestablecer tu contraseña haz click <a href="https://coderhouse-backend-production-7e93.up.railway.app/recoverLanding/${token}">aqui</a></h1>
                </div>
                `});
            } catch (error) {
